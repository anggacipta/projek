        ...
        <div class="col-md-5 col-lg-4 order-md-last">
          ...
          <ul class="list-group mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between lh-sm">
              ...
              <p class="text-muted">Rp<?= $i2['harga_paket']; $i2['harga_paket']?>"</p>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
              ...
              <p class="text-muted">Rp<?= $i2['harga_paket']*$i['jumlah'];?> <input type="hidden" name="biaya" placeholder="id" class="text-muted" readonly value="<?= $i4['harga']+$i2['harga_paket']*$i['jumlah'];?>"></p>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
                <h6 class="my-0">Diskon</h6>
                <small class="text-muted">Tidak ada diskon</small>
              </div>
              <p class="text-muted">Rp0<input type="hidden" name="diskon" placeholder="tidak ada diskon" class="text-muted" readonly value=""></p>
            </li>
            <li class="list-group-item d-flex justify-content-between">
              <span>Total (IDR)</span>
              <p class="text-muted">Rp<?= $i2['harga_paket']*$i['jumlah']; ?> <input type="hidden" name="total_bayar" placeholder="total_bayar" readonly value="<?= $i4['harga']+$i2['harga_paket']*$i['jumlah']; ?>"></p>
            </li>
          </ul>
        </div>
        <!-- End Product -->
