...
<html lang="en">
  ...
  <header class="header" id="header">
    ...
    <h2>Pemesanan Membership(telah diverifikasi)</h2>
...
include "../config.php";
$no=1;
$ambil= mysqli_query($connect, "select * from membership where hidden='no'");
while($tampil = mysqli_fetch_array($ambil)){
    ...
    <tr>
        ...
        <td><?php echo"<img src='/img/".$tampil['foto']."' width='25%' height='25%'>"; ?></td>
