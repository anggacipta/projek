...
include "../config.php";
$no=1;
$ambil= mysqli_query($connect, "select * from transaksi where hidden = 'yes'");
while($tampil = mysqli_fetch_array($ambil)){
    ...
    <tr>
        ...
        <td><a href="update_pembelian.php?id_transaksi=<?php echo $tampil['id_transaksi']; ?>" class="btn btn-primary">Verifikasi</a></td>
    </tr>
