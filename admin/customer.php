...
include "../config.php";
$no=1;
$ambil= mysqli_query($connect, "select * from customer ");
while($tampil = mysqli_fetch_array($ambil)){
    ...
    <tr>
        ...
        <td>
            ...
            <a href="edit.php?id_cust=<?php echo $tampil['id_cust']; ?>">EDIT</a>
            <a href="hapus.php?id_cust=<?php echo $tampil['id_cust']; ?>">HAPUS</a>
        </td>
    </tr>
