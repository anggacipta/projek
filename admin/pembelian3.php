...
<html lang="en">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Laporan Hari Ini</th>
    </tr>
  </thead>
...
include "../config.php";
$no=1;
$ambil= mysqli_query($connect, "select * from transaksi where SUBSTR(tgl_bayar, 1,10) = DATE(NOW()) && hidden = 'no'");
while($tampil = mysqli_fetch_array($ambil)){
    ...
    <tr>
        ...
        <td>
        <a href="update_status.php?id_transaksi=<?php echo $tampil['id_transaksi']; ?>" class="btn btn-primary">Update</a>
        </td>
        <td><a href="cetak2.php" class="btn btn-dark" target="_blank">Cetak</a></td>
    </tr>
