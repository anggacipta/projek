...
<html lang="en">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Laporan Minggu Ini</th>
    </tr>
  </thead>
...
include "../config.php";
$no=1;
$ambil= mysqli_query($connect, "select * from transaksi where YEARWEEK(tgl_bayar) = YEARWEEK(NOW())");
while($tampil = mysqli_fetch_array($ambil)){
    ...
    <tr>
        ...
        <td><a href="cetak3.php" class="btn btn-dark" target="_blank">Cetak</a></td>
    </tr>
